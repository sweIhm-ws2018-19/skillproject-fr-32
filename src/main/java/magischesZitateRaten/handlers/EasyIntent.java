...
public class EasyIntent implements RequestHandler {

    @Override
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("LeichtIntent").and(sessionAttribute(Attributes.STATE_KEY, Attributes.QUIZ_STATE_SELECT_DIFFICULTY) ));
    }
