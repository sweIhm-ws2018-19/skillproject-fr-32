...
import com.amazon.ask.quiz.handlers.MiddleIntent;
...
public class TestMiddleIntent {

    private MiddleIntent handler;

    @Before
    public void setup() {
        handler = new MiddleIntent();
    }

    @Test
    public void testCtor() {
        assertEquals(handler.getClass(), MiddleIntent.class);
    }
    ...
    public void handleSlotNotNullTest(){
        ...
        assertTrue(response.getOutputSpeech().toString().contains("Du hast"));
    }
